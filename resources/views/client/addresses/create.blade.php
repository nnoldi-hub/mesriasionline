...
@section('title', 'Adaugă Adresă')
@section('page-title', 'Adaugă Adresă Nouă')

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('client.addresses.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                @enderror
                <p class="mt-1 text-xs text-gray-500">O denumire pentru a identifica ușor această adresă</p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="entrance" name="entrance" value="{{ old('entrance') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600"
                        placeholder="B">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="county" name="county" value="{{ old('county') }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Selectează zona pentru a găsi meșteri disponibili în apropiere</p>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea id="notes" name="notes" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600"
                    placeholder="ex: Interfon 42, codul de la poartă: 1234, căutați la etajul 3 pe dreapta...">{{ old('notes') }}</textarea>
                <p class="mt-1 text-xs text-gray-500">Informații utile pentru meseriaș când vine la această adresă</p>
            </div>
