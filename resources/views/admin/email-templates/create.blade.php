...
@section('title', 'Creează Template Email')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Creează Template</li>
                </ol>
            </nav>
            <h1 class="h3 mb-0 mt-2">Creează Template Nou</h1>
        </div>
    </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @error('notification_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Asociază template-ul cu un tip de notificare pentru a-l folosi automat.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('subject')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Poți folosi variabile precum <code>@{{user_name}}</code></small>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Salvează Template
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card sticky-top" style="top: 80px;">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-3">
                            Selectează un tip de notificare pentru a vedea variabilele disponibile. 
                            Click pe o variabilă pentru a o copia.
                        </p>

                        <div id="variablesContainer">
                            @foreach($availableVariables as $type => $variables)
                                <div class="variables-group d-none" data-type="{{ $type }}">
                            ...
                            <div id="noVariables" class="text-center text-muted py-4">
                        ...
                        <div class="small">
                            <div class="d-flex justify-content-between py-1">
                                <code># Titlu</code>
                                <span class="text-muted">Greeting (salutare)</span>
                            </div>
                            <div class="d-flex justify-content-between py-1">
                                <code>**text**</code>
                            ...
                            <div class="d-flex justify-content-between py-1">
                                <code>[Text](url)</code>
                                <span class="text-muted">Buton de acțiune</span>
                            </div>
                            <div class="d-flex justify-content-between py-1">
                                <code>-- Semnătură</code>
                                <span class="text-muted">Salutare finală</span>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Afișează variabilele când se schimbă tipul de notificare
    notificationTypeSelect.addEventListener('change', function() {
        const type = this.value;
        
        // Ascunde toate grupurile
    ...
    // Click pe variabilă pentru a o insera
    ...
    // Trigger la încărcare dacă există valoare
    if (notificationTypeSelect.value) {
        notificationTypeSelect.dispatchEvent(new Event('change'));
    }
});
</script>
@endpush
