...
@section('title', 'Politica Cookies - Fixacasa')
@section('description', 'Află ce sunt cookies, cum le folosim pe Fixacasa și cum poți gestiona preferințele tale.')

@section('content')
<div class="max-w-3xl mx-auto bg-white rounded-lg shadow p-8 mt-8">
    <h1 class="text-3xl font-bold mb-6">Politica Cookies</h1>
    <p class="mb-4">Această pagină explică ce sunt cookies, cum le folosim pe platforma Fixacasa și ce opțiuni ai pentru gestionarea lor.</p>
    ...
    <h2 class="text-xl font-semibold mt-6 mb-2">Cum folosim cookies pe Fixacasa?</h2>
    ...
    <p>Pentru detalii suplimentare, consultă <a href="{{ route('privacy') }}" class="underline text-primary-600">Politica de confidențialitate</a> sau contactează-ne la <a href="mailto:contact@fixacasa.ro" class="underline text-primary-600">contact@fixacasa.ro</a>.</p>
</div>
@endsection
